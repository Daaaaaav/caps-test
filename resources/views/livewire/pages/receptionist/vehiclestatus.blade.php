                                    ...
                                    <div class="space-y-3">
                                        <div class="flex items-start gap-4">
                                            ...
                                            <div class="flex-1 min-w-0">
                                                ...
                                                {{-- Overdue banner (late_return only) --}}
                                                @if($overdue)
                                                    <div class="flex items-center gap-2 px-3 py-2 rounded-lg bg-orange-50 border border-orange-200 text-orange-800 text-xs font-semibold mb-2">
                                                        <svg class="w-3.5 h-3.5 shrink-0 text-orange-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01M10.29 3.86L1.82 18a2 2 0 001.71 3h16.94a2 2 0 001.71-3L13.71 3.86a2 2 0 00-3.42 0z"/>
                                                        </svg>
                                                        <span>{{ __('app.overdue_by') }}: <span class="font-bold">{{ $overdue }}</span></span>
                                                    </div>
                                                @endif
